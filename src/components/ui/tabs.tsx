...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap text-foreground/60 transition-all",
        ...
        // shape
        "rounded-md group-data-[variant=line]/tabs-list:rounded-none",
        ...
        "dark:group-data-[variant=default]/tabs-list:data-[state=active]:text-foreground",
        ...
        "group-data-[orientation=vertical]/tabs:after:right-0",
